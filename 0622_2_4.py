...
target_chunks = 12    # 표에 보이는 X축 개수를 조절하기 위한 숫자 설정 -> 모수, 대체적으로 10 ~ 30정도                           
